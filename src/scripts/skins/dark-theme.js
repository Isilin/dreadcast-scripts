...
(function () {
  let css = `
    ...
    #zone_chat_bg{
        background: url('https://i.imgur.com/47mpu9O.png') !important;
    ...
    #zone_droite>.grid>.grid.top {
        ...
        position: relative !important;
        background: url('https://i.imgur.com/3bCT2ob.png') no-repeat !important;
    ...
    #zone_gauche {
        ...
        background: url('https://i.imgur.com/WYVPxIT.png') 0 0 no-repeat !important;
        background-size: contain !important;
    }
    ...
    #combat_menu>div, #zone_actions>div {
      box-sizing: border-box !important;
        background: url('https://i.imgur.com/U6Tu0Sk.png') left top no-repeat !important;
        background-size: contain !important;
