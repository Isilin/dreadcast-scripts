  ...
  $('#liste_messages .message:not(.ui-draggable)').draggable({
    ...
    start: function () {
      if (
        ...
        'url(https://cdn1.iconfinder.com/data/icons/win8-and-ios-tab-bar-icons/30/Unlock.png)'
      )
...
lock.setAttribute(
  'style',
  "width:32px;height:30px;background-image:url('https://cdn1.iconfinder.com/data/icons/win8-and-ios-tab-bar-icons/30/Lock.png');background-repeat: no-repeat;background-position: 33px 0;position: absolute; right: 0px;z-index: 999999;",
);
...
$('#lock')
  ...
  .css('left', '120px')
  .css('top', '5px')
  .css('background-size', '15px 15px')
  .addClass('link');

lock.onclick = function () {
  if (
    document.getElementById('lock').style.backgroundImage.replace(/\"/g, '') ==
    'url(https://cdn1.iconfinder.com/data/icons/win8-and-ios-tab-bar-icons/30/Unlock.png)'
  )
    document.getElementById('lock').style.backgroundImage =
      'url("https://cdn1.iconfinder.com/data/icons/win8-and-ios-tab-bar-icons/30/Lock.png")';
  else
    document.getElementById('lock').style.backgroundImage =
      'url("https://cdn1.iconfinder.com/data/icons/win8-and-ios-tab-bar-icons/30/Unlock.png")';
};
